# Generated by Django 3.2.8 on 2022-08-18 20:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ManyToManyField(through='recipes.Component', to='recipes.Product')),
        ...
        migrations.AddField(
            ...
            name='ingredient',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingredient', to='recipes.product', verbose_name='Ингредиент'),
        ),
        migrations.AddField(
            model_name='component',
            name='recipe',
